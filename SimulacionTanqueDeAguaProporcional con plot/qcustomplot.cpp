...
bool QCustomPlot::addPlottable(QCPAbstractPlottable *plottable)
{
  ...
  {
    qDebug() << FUNCNAME << "plottable either already in list or not created with this QCustomPlot as parent:" << reinterpret_cast<quintptr>(plottable);
    return false;
  }
}
...
bool QCustomPlot::removePlottable(QCPAbstractPlottable *plottable)
{
  ...
  {
    qDebug() << FUNCNAME << "plottable not in list:" << reinterpret_cast<quintptr>(plottable);
    return false;
  }
}
