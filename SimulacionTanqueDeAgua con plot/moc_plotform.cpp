...
**
** Created: Sun Jun 17 00:39:36 2012
...
static const char qt_meta_stringdata_PlotForm[] = {
    "PlotForm\0\0Y,y\0Graficar(double,double)\0"
};
...
void PlotForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Graficar((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
    }
}
